...
//still don't get what's going on with the promises
describe('BlogPosts', function() {
  ...
  it('should list blog posts on GET', function() {
    ...
    return chai.request(app)
      ...
      .then(function(res) {
        ...
        // for `id`, `title`, `author`, and `content`.
  ...
  it('should add a recipe on POST', function() {
    const newBlogPost = {
        title: 'what it do?', content: 'To smite or be smitten?', author: 'Biffany PigMuck-Hole'};
    return chai.request(app)
      .post('/blog-posts')
      .send(newBlogPost)
      .then(function(res) {
